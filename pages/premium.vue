<template>
  <div>
    <Heading title="Premium [NOT YET RELEASED]">
      Get Poxx Premium to upgrade your server experience and support the development work!
    </Heading>
    ...
    <div class="text-left mt-5 pt-4">
      ...
      <p>
        ...
        contact Snow (_Snow#0001) on Discord for more information.
      </p>
    </div>
  </div>
</template>
        ...
        domProps: {
          innerHTML: `
            ...
            <form id="premium-form" action="https://www.paypal.com/cgi-bin/webscr" method="post"
              ...
              <input type="hidden" name="item_name" value="Poxx Premium (${name})">
