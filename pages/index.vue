...
<template>
  <div>
      ...
      <div id="hero-top-content" class="container pt-2 pb-0">
        <div class="row h-100">
          <div class="hero-top-column col-12 col-md-7 text-center text-md-left">
            ...
            <h1 class="display-1">Poxx</h1>
            <h2 class="display-4">
              Protect and engage your community!
              <br class="d-none d-lg-block" />
              Made for small servers, large servers,
              <br class="d-none d-lg-block" />
    ...
    <div class="container text-center pb-5">
      <h2 class="display-2 mt-5 pb-3"></h2>
      <p></p>
    ...
    <div id="hero-bottom-container">
      ...
      <div class="container text-center px-5 pb-5 pt-4">
        ...
        <p class="h5">The adventure has just begun! Click "Add to Discord" to start our journy</p>
        <a href="/invite" target="_blank">
          <BaseButton type="primary" size="lg" class="mt-3 mx-2 ml-md-0">
            <span class="h6 font-weight-bold">Add to Server</span>
          </BaseButton>
        </a>
